            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        <h2>Ask Question</h2>
                        <div class="ml-auto">
                        <a href="{{route('questions.index')}}" class="btn btn-outline-warning btn-lg">Back to all Questions</a>
                        </div>
                    </div>
                </div>
                ...
                <form action="{{route('questions.store')}}" method="POST" class="form">
                    ...
                    <div class="form-group">
                        <label class="form-control-label" for="question-title">Question Title</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" for="question-body">Explain your question</label>
